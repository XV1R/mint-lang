...
//Lexer Consider supporting Unicode and emojis
type Lexer struct {
	input        string
	position     int  //current position in input
	readPosition int  //current reading position(after the current one)
...
func New(input string) *Lexer {
	...
	l.readChar() //Make sure to initialize the lexer
	return l
}
